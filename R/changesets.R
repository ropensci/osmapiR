...
#' chaset
#' }
osm_read_changeset <- function(changeset_id, include_discussion = FALSE, format = c("R", "xml", "json")) {
...
#' chsts2
#' }
osm_query_changesets <- function(bbox, user, time, time_2, open, closed, changeset_ids, format = c("R", "xml", "json")) {
  format <- match.arg(format)
